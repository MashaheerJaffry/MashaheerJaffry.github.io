...
emailjs.init("tkyLv1MxlhQbkuLJU");

document.querySelector(".form").addEventListener("submit", function(event) {
  event.preventDefault();

  const serviceID = "service_pdmezth";
  const templateID = "template_ho0oo3e";
...
// Get the modal and elements to populate
...
projects.forEach(project => {
  project.addEventListener("click", function(event) {
    ...
    // Get image, title, and description from the clicked project
    ...
    modalDesc.textContent = description;  // Set description
